...
constexpr auto GRAPH_FILE ="../rKACS_ds/{0}/graph.txt";
constexpr auto TRUSSNESS_FILE = "../rKACS_ds/{0}/edge_trussness.txt";
constexpr auto ATTRIBUTE_FILE = "../rKACS_ds/{0}/user_attributes_int.txt";
constexpr auto SIMILARITY_FILE = "../rKACS_ds/{0}/edge_similarity.bin";
constexpr auto QUERY_FILE = "../rKACS_ds/{0}/{1}_query.txt";
//constexpr auto AVG_RESULT_FILE = "../rKACS_ds/{0}/Results/{0}/{1}/{2}/avg_result.txt";
constexpr auto AVG_RESULT_FILE = "../rKACS_ds/{0}/Results/avg_result.txt";
constexpr auto RESULT_FILE = "../rKACS_ds/{0}/Results/{0}/{1}/{2}/{2}_{3}_{4}.txt";
constexpr auto QUALITY_RESULT_FILE = "../rKACS_ds/{0}/Results/{0}/quality/{1}_quality_result.txt";
